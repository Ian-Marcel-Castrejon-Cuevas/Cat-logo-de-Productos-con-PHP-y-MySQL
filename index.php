...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/caja.css" type="text/css">
    <title>..INDEX...</title>
  </head>
  <body>
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark">
    ...
    <div class="container-table">
        <div class="table__title">Datos del producto</div>
          ...
          ?>
          <div class="table__item"><?php echo $row["prodid"]; ?></div>
          <div class="table__item"><img height="50px" src="data:image/jpg;base64, <?php echo base64_encode($row["img"]) ?>"></div>
